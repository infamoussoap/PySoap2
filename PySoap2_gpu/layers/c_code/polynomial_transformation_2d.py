...
__kernel void polynomial_transform_2d(__global const double *P1, __global const double *P2, 
...
__kernel void polynomial_transform_2d_multi(__global const double *P1, __global const double *P2, 
                                            __global const double *images, const int M1, const int M2,
                                            const int M3, const int input_length, __global double *out)
{
